...
INSERT INTO menu(pk_menu_id, menu_type, menu_name, label,icon, admin_menu, menu_status, fk_menu_id)
	VALUES(1, 'HOME', 'vehicles', 'vehicles','car.png',0,1,null),
		...
		(null, 'SUBMENU', 'cars', 'cars', null,0,1, 1),
		(null, 'SUBMENU', 'motocycles', 'motocycles', null,0,1, 1),
		(null, 'SUBMENU', 'farm vehicles', 'farmvehicles', null,0,1, 1),
		(null, 'SUBMENU', 'auto parts', 'autoparts', null,0,1, 1),
		(null, 'SUBMENU', 'house for rent', 'houseforrent', null,0,1, 2),
		(null, 'SUBMENU', 'house to wanted', 'housetoshare', null,0,1, 2),
		(null, 'SUBMENU', 'house for sale', 'houseforsale', null,0,1, 2),
		(null, 'SUBMENU', 'commercial for sale', 'commercialforsale',null,0,1, 2),
		(null, 'SUBMENU', 'plot for sale', 'plotforsale', null,0,1, 2),
		(null, 'SUBMENU', 'cats', 'cats', null,0,1, 3),
		(null, 'SUBMENU', 'dogs', 'dogs', null,0,1, 3),
		(null, 'SUBMENU', 'pets lost & found', 'petslost&found', null,0,1, 3),
		(null, 'SUBMENU', 'free pets', 'free pets', null,0,1, 3),
		(null, 'SUBMENU', 'mobile phones', 'mobilephones', null,0,1, 4),
		(null, 'SUBMENU', 'phone accessories', 'phoneaccessories', null,0,1, 4),
		(null, 'SUBMENU', 'tablets', 'tablets', null,0,1, 4),
		(null, 'SUBMENU', 'computers', 'computers', null,0,1, 4),
		(null, 'SUBMENU', 'TVs and radios', 'TVsandradios', null,0,1, 4),
		(null, 'SUBMENU', 'landscaping', 'landscaping', null,0,1, 5),
		(null, 'SUBMENU', 'appliances', 'appliances', null,0,1, 5),
		(null, 'SUBMENU', 'furniture', 'furniture', null,0,1, 5),
		(null, 'SUBMENU', 'antiques', 'antiques', null,0,1, 5),
		(null, 'SUBMENU', 'camping gear', 'campinggear',null,0,1, 6),
		(null, 'SUBMENU', 'tennis', 'tennis', null,0,1, 6),
		(null, 'SUBMENU', 'swimming', 'swimming', null,0,1, 6),
		(null, 'SUBMENU', 'books and games', 'booksandgames', null,0,1, 6),
		(null, 'SUBMENU', 'construction', 'construction', null,0,1, 12),
		(null, 'SUBMENU', 'pools and garden', 'poolsandgarden', null,0,1, 12),
		(null, 'SUBMENU', 'home maintenace', 'homemaitenance', null,0,1, 12),
		(null, 'SUBMENU', 'health and beauty', 'health and beauty', null,0,1, 12),
		(null, 'SUBMENU', 'dashboard', 'dashboard', null,0,1, 13),
		(null, 'SUBMENU','profile','profile', null,0,1, 14),
		(null, 'SUBMENU','preferences','preferences', null,0,1, 14),
		(null, 'SUBMENU','communication','communication', null,0,1, 14),
		(null, 'SUBMENU','activity', 'activity', null,1,1, 14),
		(null, 'SUBMENU','users', 'users', null,1,1, 15),
		(null, 'SUBMENU','menus', 'menus', null,1,1, 15),
		(null, 'SUBMENU','posts', 'posts', null,0,1, 15);
